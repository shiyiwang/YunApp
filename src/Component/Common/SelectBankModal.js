...
const OPTION_CONTAINER_HEIGHT = 300;
...
export default class SelectBankModal extends Component {
...
SelectBankModal.propTypes = propTypes;
SelectBankModal.defaultProps = defaultProps;
